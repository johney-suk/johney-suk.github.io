      ...
      {% if author.email %}
        <li>
          <a href="mailto:{{ author.email }}" rel="me" class="u-email">
            ...
            <i class="fas fa-fw fa-envelope-square" aria-hidden="true"></i><span class="label">sukhyunil19@gmail.com</span>
          </a>
        </li>
      {% endif %}
      ...
      {% if author.github %}
        <li>
          <a href="https://github.com/{{ author.github }}" itemprop="sameAs" rel="nofollow noopener noreferrer me">
            <i class="fab fa-fw fa-github" aria-hidden="true"></i><span class="label">https://github.com/johney-suk</span>
          </a>
        </li>
      {% endif %}
